...
extern const unsigned short BlankTreeBGPal[256];
# 13 "main.c" 2
# 1 "JumpAround.h" 1
# 20 "JumpAround.h"
...
void goToStart() {
    ...
    DMANow(3, StartScreenTiles, &((charblock *)0x6000000)[1], 2976/2);
    DMANow(3, StartScreenMap, &((screenblock *)0x6000000)[29], 2048/2);
...
void start() {
    ...
    if ((!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
        stopSound();
        playSoundB(GameSong, 2977920, 11025, 1);
        initGame();
        goToGame();
    }
...
void goToGame() {
    ...
    DMANow(3, BlankTreeBGPal, ((unsigned short *)0x5000000), 256);
...
void goToPause() {
    ...
    DMANow(3, PauseScreenTiles, &((charblock *)0x6000000)[1], 3552/2);
    DMANow(3, PauseScreenMap, &((screenblock *)0x6000000)[29], 2048/2);
...
void goToWin() {
    ...
    DMANow(3, WinScreenTiles, &((charblock *)0x6000000)[1], 2592/2);
    DMANow(3, WinScreenMap, &((screenblock *)0x6000000)[29], 2048/2);
...
void goToLose() {
    ...
    DMANow(3, LoseScreenTiles, &((charblock *)0x6000000)[1], 2656/2);
    DMANow(3, LoseScreenMap, &((screenblock *)0x6000000)[29], 2048/2);
